    ...
    return (
        <div className="flex items-center gap-2 rounded-md border border-dashed border-primary px-3 py-2">
            <input
                ...
                className="min-w-0 flex-1 rounded-md border border-input bg-background px-2 py-1 text-base md:text-sm outline-none focus:ring-2 focus:ring-ring"
            />
            <select
                ref={unitRef}
                value={unit}
                ...
                className="w-14 rounded-md border border-input bg-background px-1 py-1 text-sm"
            >
                {UNITS.map((u) => (
